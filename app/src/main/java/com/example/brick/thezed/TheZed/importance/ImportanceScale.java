...
public class ImportanceScale 
{
	...
	//common word, Count
	private HashMap<String, Double> sleepMap, mealMap, testMap, homeWorkMap
            , skillTrainingMap, projectBuildingMap, entertainmentMap, generalStudyMap
            , socialTimeMap, anomalyMap;
